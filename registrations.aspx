...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table style="width: 55%; background-color: #FFFFFF; height: 273px; margin-left: 104px; font-family: Arial, Helvetica, sans-serif; font-size: small; position: relative; table-layout: inherit; left: -28px; top: -3px;">
        <tr>
        ...
        <tr>
            ...
            <td style="width: 540px; text-align: left">
                <asp:TextBox ID="TextBox3" runat="server" Width="290px" Height="19px"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td style="height: 24px; width: 213px; text-align: right;">City :</td>
            <td style="height: 24px; width: 540px; text-align: left;">
                <asp:TextBox ID="TextBox4" runat="server" Width="290px" Height="20px"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td style="width: 213px; height: 20px; text-align: right;">State :</td>
            <td style="width: 540px; height: 20px; text-align: left">
                <asp:TextBox ID="TextBox5" runat="server" Width="290px" Height="20px"></asp:TextBox>
            </td>
        </tr>
        <tr>
